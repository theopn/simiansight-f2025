...
prompt = """
You are given the list of behavior captions for animal videos in CSV format.
You are also given the list of buckets and corresponding explanation.
Put each videos in buckets and return the result in CSV format.
""" + "Buckets:\n" + buckets + "\nCaptions\n" + captions

with lmdeploy.pipeline(MODEL_PATH, log_level='INFO', max_new_tokens=4096) as pipe:
